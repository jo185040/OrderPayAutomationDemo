...
#Action: 10 Apply HERE Ordermode
			Then verify presence of /EntriesBySeat/,"Seat 1","BBQ RIBS\ 1/2 RACK\ 1/2 RACK\ Baked Potato\ CUP","41.89"
			Then clicked [HERE]
...
#Action: 14 Click Close
			Then verify presence of /ItemEntries/,"Seat 1","7 UP","2.00","COKE\ COKE","2.00",/Comps/,"4.00",/Taxes/,"4.00",/Tenders/,"4.00"
			Then clicked /MidButtons/,[Close]
...
#Action: 12 Verify prices, order items HERE
			Then verify presence of /EntriesBySeat/,"Seat 1","TENDERLN WRAPS\ Baked Potato\ ADD AVOCADO","5.00\\0.80"
			Then clicked [HERE]
...
#Action: 8 On Soup Mod, select Cup
			...
			Then clicked [CUP]
#Action: 9 Apply HERE Ordermode
			Then verify presence of /EntriesBySeat/,"Seat 1","PORK CHOP\ MEDIUM\ Red Beans\ CUP","12.99"
			Then clicked [HERE]
#Action: 10 Select $ on Payment Screen
			Then verify presence of /EntriesBySeat/,"Seat 1","PORK CHOP\ MEDIUM\ Red Beans\ CUP","12.99"
			Then clicked [$]
#Action: 11 Exact Payment
			Then verify presence of /ItemEntries/,"Seat 1","PORK CHOP\ MEDIUM\ Red Beans\ CUP","12.99",/Comps/,"Sub Total","12.99",/Taxes/,"Tax","0.79","Total","13.78",/Tenders/,"Balance Due","$13.78"
			Then clicked [Exact]
#Action: 12 Click Close
			Then verify presence of /ItemEntries/,"Seat 1","PORK CHOP\ MEDIUM\ Red Beans\ CUP","12.99",/Comps/,"Sub Total","12.99",/Taxes/,"Tax","0.79","Total","13.78",/Tenders/,"Balance Due","$13.78","Change","$0.00","CASH"
			Then clicked /MidButtons/,[Close]
#Action: 13 Exit FloorPlan
			Given screen state: 558
			When clicked [Exit]
...
#Action: 8 On Soup Mod, select Cup
			...
			Then clicked [CUP]
#Action: 9 Apply HERE Ordermode
			Then verify presence of /EntriesBySeat/,"Seat 1","PORK CHOP\ MEDIUM\ Black Beans\ CUP","11.99\\1.00"
			Then clicked [HERE]
#Action: 10 Select $ on Payment Screen
			Then verify presence of /EntriesBySeat/,"Seat 1","PORK CHOP\ MEDIUM\ Black Beans\ CUP","11.99\\1.00"
			Then clicked [$]
#Action: 11 Exact Payment
			Then verify presence of /ItemEntries/,"Seat 1","PORK CHOP\ MEDIUM\ Black Beans\ CUP","11.99\\1.00",/Comps/,"Sub Total","12.99",/Taxes/,"Tax","0.79","Total","13.78",/Tenders/,"Balance Due","$13.78"
			Then clicked [Exact]
#Action: 12 Click Close
...
#Action: 8 Apply HERE Ordermode
			Then verify presence of /EntriesBySeat/,"Seat 1","Special Burger\ RARE\ BACON","6.50"
			Then clicked [HERE]
#Action: 9 Select $ on Payment Screen
			Then verify presence of /EntriesBySeat/,"Seat 1","Special Burger\ RARE\ BACON","6.50"
			Then clicked [$]
#Action: 10 Exact Payment
			Then verify presence of /ItemEntries/,"Seat 1","Special Burger\ RARE\ BACON","6.50",/Comps/,"Sub Total","6.50",/Taxes/,"Tax","0.40","Total","6.90",/Tenders/,"Balance Due","$6.90"
			Then clicked [Exact]
#Action: 11 Click Close
			Then verify presence of /ItemEntries/,"Seat 1","Special Burger\ RARE\ BACON","6.50",/Comps/,"Sub Total","6.50",/Taxes/,"Tax","0.40","Total","6.90",/Tenders/,"Balance Due","$6.90","Change","$0.00","CASH"
			Then clicked /MidButtons/,[Close]
...
#Action: 9 On Starch press Baked Potato OK
			...
			Then clicked /RightPanelButtons/,[BACON]
#Action: 10 Apply HERE Ordermode
			Then verify presence of /EntriesBySeat/,"Seat 1","Special Burger\ BACON\ BACON","7.50"
			Then clicked [HERE]
#Action: 11 Select $ on Payment Screen
			Then verify presence of /EntriesBySeat/,"Seat 1","Special Burger\ BACON\ BACON","7.50"
			Then clicked [$]
#Action: 12 Exact Payment
			Then verify presence of /ItemEntries/,"Seat 1","Special Burger\ BACON\ BACON","7.50",/Comps/,"Sub Total","7.50",/Taxes/,"Tax","0.46","Total","7.96",/Tenders/,"Balance Due","$7.96"
			Then clicked [Exact]
#Action: 13 Click Close
			Then verify presence of /ItemEntries/,"Seat 1","Special Burger\ BACON\ BACON","7.50",/Comps/,"Sub Total","7.50",/Taxes/,"Tax","0.46","Total","7.96",/Tenders/,"Balance Due","$7.96","Change","$0.00","CASH"
			Then clicked /MidButtons/,[Close]
#Action: 14 Exit FloorPlan
			Given screen state: 558
			When clicked [Exit]
